...
import { UserMeetings } from "../components/UserDashboard/Meetings";
...
export function User() {
    ...
    const fetchMeetings = () => {
        ...
        .then((response) => {
            const meetings = response.data.filter(user => user.pacient.email === "joe@doe.com");
    ...
    React.useEffect(() => {
        ...
        fetchMeetings();//send user email or cedula param
    }, []);

    console.log("flag1",data);//flag
    console.log("flag2",!data);//flag
    ...
    return (
        ...
        <div className="master">
            ...
            <div className="dashboardcontent container d-flex flex-column mt-5 m-4">
                ...
                {active === '1' ? <UserHome data={data}/> : ""}
                {active === '2' ? <UserMeetings data={meeting}/> : ""}
                {active === '3' ? <p>3</p> : ""}
